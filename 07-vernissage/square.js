...
// Objects repetition
let max_forms_square = 20;
let max_forms_triangle = 15;
let max_forms_circles = 15;
let form_sep = 1.5;
...
let color_array = [];
let sq_size = (w - ext_space * 2 - int_space * (dim_cube - 1)) / dim_cube;
var cube;
...
function txtBottom() {
    ...
    if (add_text) {
        ...
        textAlign(100);
        textSize(h * 0.025);
        // text("is it already bauhaus?", 100, h * 0.031);
        pop();
    }
}
