...
function bezier_func(l) {
    ...
    for (let j = 0; j < steps; j++) {
        ...
        x4 = (noise(offset + i * 57) * width + j4) * l - 100
        y4 = (noise(offset + i * 58) * height + j4) * l - 100
    ...
    for (let j = 0; j < steps; j++) {
        ...
        y1 = (noise(offset + i * 2) * height + j1) * l + 250
        x2 = (noise(offset + i * 3) * width + j2) * l + 100
        y2 = (noise(offset + i * 4) * height + j2) * l + 100
        x3 = (noise(offset + i * 5) * width + j3) * l + 100
        y3 = (noise(offset + i * 6) * height + j3) * l + 100
