...
function art() {
    ...
    const nValues = [2, 3, 5, 7];

    for (const n of nValues) {
    for (let b = 2; b < 5; b += abstep) {
    for (let a = 1; a < 5; a += abstep) {
    ...
    // noFill()
    // let ncols = 3;
    // let sqstep = (leftmargin - rightmargin) / ncols;
    // for(let i = 0; i < 9; i++){
    //     square(leftmargin, topmargin + random(0,400), 10)
    // }
    // for(let i = 0; i < 6; i++){
    //     square(center_x - 5, topmargin + random(0,400), 10)
    // }
    // for(let i = 0; i < 4; i++){
    //     square(rightmargin - 10, topmargin + random(0,400), 10)
    // }
}
